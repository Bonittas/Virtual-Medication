        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center">
            <div className="bg-white p-6 rounded-full mb-6">
              <FontAwesomeIcon icon={faUserMd} className="text-4xl text-blue-300" />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white p-6 rounded-full mb-6">
              <FontAwesomeIcon icon={faLaptopMedical} className="text-4xl text-blue-300" />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="bg-white p-6 rounded-full mb-6">
              <FontAwesomeIcon icon={faComments} className="text-4xl text-blue-300" />
            </div>
